...
mkdir -p "$PROJECT_C/src/bin"
printf 'export function cliEntry() { return true }\n' > "$PROJECT_C/src/bin/cli.ts"
printf '// @generated\nexport const generatedValue = true\n' > "$PROJECT_C/src/generated.ts"
printf 'This file was generated by a fixture tool.\nexport const generatedBy = true\n' > "$PROJECT_C/src/generated-by.ts"
printf 'export const generatedAt = "2026-01-01T00:00:00Z"\n' > "$PROJECT_C/src/generated-at.ts"
mkdir -p "$PROJECT_C/docs" "$PROJECT_C/tests/generated"
printf '# Scanner notes\n\nThis document discusses generated output without being generated.\n' > "$PROJECT_C/docs/generated-output.md"
printf 'import { describe } from "vitest"\n\n// Mentions a generated marker regression case.\nexport const markerCase = true\n' > "$PROJECT_C/tests/generated/generated-marker.test.ts"
...
assert files["src/bin/cli.ts"]["indexed"] is True, "src/bin source should not be skipped"
...
assert files["src/generated-by.ts"]["indexed"] is False, "generated-by header indexed"
assert files["src/generated-by.ts"]["reason"] == "generated", "generated-by reason"
assert files["src/generated-at.ts"]["indexed"] is True, "generatedAt false positive"
assert files["docs/generated-output.md"]["indexed"] is True, "generated output doc false positive"
assert files["tests/generated/generated-marker.test.ts"]["indexed"] is True, "generated marker false positive"
