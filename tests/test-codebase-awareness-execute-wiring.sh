...
check_execute_surface() {
  ...
  assert_contains "$file" '--extracts-output "$FILE_EXTRACTS_PATH"' "$label writes scanner extraction cache"
  assert_contains "$file" '--previous-extracts "$FILE_EXTRACTS_PATH"' "$label reuses previous extraction input when present"
  ...
  assert_contains "$file" 'FILE_EXTRACTS_PATH=".signum/cache/file-extracts-v1.json"' "$label writes canonical file extraction cache"
...
assert_pr1c_artifacts_present() {
  ...
  assert_contains "$project/.signum/cache/file-extracts-v1.json" '"schemaVersion"' "$label creates project file extraction cache"
...
assert_pr1c_artifacts_absent() {
  ...
  assert_missing "$project/.signum/cache/file-extracts-v1.json" "$label does not create project file extraction cache"
...
run_scanner_failure_fixture() {
  ...
  assert_missing "$project/.signum/cache/file-extracts-v1.json" "scanner failure does not create file extraction cache"
...
run_matcher_failure_fixture() {
  ...
  assert_contains "$project/.signum/cache/file-extracts-v1.json" '"schemaVersion"' "matcher failure still creates project file extraction cache"
