...
assert_contains_file "root signum-ci invokes Codex agent review checker" "check_codex_agent_review.py" "$REPO_ROOT/lib/signum-ci.sh"
assert_contains_file "overlay signum-ci invokes Codex agent review checker" "check_codex_agent_review.py" "$REPO_ROOT/platforms/claude-code/lib/signum-ci.sh"
